...
<head>
	<meta charset="UTF-8">
	<title>『豪情』后台管理</title>
	<link rel="stylesheet" type="text/css" href="<?php echo get_css('common.css');?>"/>
	<link rel="stylesheet" type="text/css" href="<?php echo get_css('main.css');?>"/>
	<script type="text/javascript" src="<?php echo get_js('libs/modernizr.min.js');?>"></script>
</head>
<body>
<div class="topbar-wrap white">
	<div class="topbar-inner clearfix">
		<div class="topbar-logo-wrap clearfix">
			<h1 class="topbar-logo none"><a href="<?php echo site_url();?>" class="navbar-brand">后台管理</a></h1>
			<ul class="navbar-list clearfix">
				<li><a class="on" href="<?php echo site_url();?>">首页</a></li>
